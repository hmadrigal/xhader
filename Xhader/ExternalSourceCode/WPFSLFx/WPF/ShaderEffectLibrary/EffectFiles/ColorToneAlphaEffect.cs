...
namespace ShaderEffectLibrary
{
    ...
    /// </summary>
    public class ColorToneAlphaEffect : ShaderEffect
    {
        ...
        public static readonly DependencyProperty InputProperty =
            ShaderEffect.RegisterPixelShaderSamplerProperty("Input", typeof(ColorToneAlphaEffect), 0);
        ...
        public static readonly DependencyProperty DesaturationProperty =
            DependencyProperty.Register("Desaturation", typeof(double), typeof(ColorToneAlphaEffect), new UIPropertyMetadata(0.5, PixelShaderConstantCallback(0)));
        ...
        public static readonly DependencyProperty TonedProperty =
            DependencyProperty.Register("Toned", typeof(double), typeof(ColorToneAlphaEffect), new UIPropertyMetadata(1.0, PixelShaderConstantCallback(1)));
        ...
        public static readonly DependencyProperty LightColorProperty =
            DependencyProperty.Register("LightColor", typeof(Color), typeof(ColorToneAlphaEffect), new UIPropertyMetadata(Color.FromArgb(255, 255, 229, 128), PixelShaderConstantCallback(2)));
        ...
        public static readonly DependencyProperty DarkColorProperty =
            DependencyProperty.Register("DarkColor", typeof(Color), typeof(ColorToneAlphaEffect), new UIPropertyMetadata(Color.FromArgb(255, 51, 128, 0), PixelShaderConstantCallback(3)));
